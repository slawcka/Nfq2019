...
const Specialist = (props) => {
    ...
    const { state, changeSpec, serveClient } = props;
    let currentClientNumber, currentQueue;
    const specialist = (state.activeSpec === "spec1") ? "Javascript"
    ...
    const showClient = (e) => {
        ...
        return <div className="specialist__queue">
            ...
            {(currentQueue < 1) ? <p>eilėje nėra klientų</p> : <button className="btn" onClick={serveClient}>aptarnauta</button>}
        </div>
    }
    return (
